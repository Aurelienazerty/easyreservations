		...
		function get_pagenum_link($id){
				if(strpos($this->target,'?')===false)
						if($this->urlF)
								...
								return "easyreservation_send_table('$this->target',$id)";
					else
						return "easyreservation_send_table('$this->target',$id)";
			}
				...
				if($lastpage > 1){
						...
						elseif($lastpage > 5 + ($this->adjacents * 2)){//enough pages to hide some
								...
								if($this->page < 1 + ($this->adjacents * 2)){
										...
										$this->pagination .= "...";
										$this->pagination .= "<a onclick=\"".$this->get_pagenum_link($lpm1)."\">$lpm1</a>";
										$this->pagination .= "<a onclick=\"".$this->get_pagenum_link($lastpage)."\">$lastpage</a>";
									}
								//in middle; hide some front and some back
								
								elseif($lastpage - ($this->adjacents * 2) > $this->page && $this->page > ($this->adjacents * 2)){
										$this->pagination .= "<a onclick=\"".$this->get_pagenum_link(1)."\">1</a>";
										$this->pagination .= "<a onclick=\"".$this->get_pagenum_link(2)."\">2</a>";
										$this->pagination .= "...";
